...
void main() {
  ...
  testWidgets("Person info view", (tester) async {
    ...
    final repository = PersonRepository(mock);
    await repository.deleteAll();
    final nameOnly = factory.create("Demo person");
    final nameAndNickname = factory.create("Demo person", nickname: "demo");
    final registeredBirthdate = factory.create("Demo person");
    ...
    expect(find.text("${AgeCalculator.age(registeredBirthdate.birthdate).years} years old"), findsOneWidget);
  });
}
